Attribute VB_Name = "AB_UIState"
Option Explicit

'=======================================================
' Module: AB_UIState
' Purpose: UI state management and caching
' Author: Refactored - November 2025
' Version: 1.0
'
' Description:
'   Central management of UI state, caching, and flags.
...
'
' Usage:
'   Call InitializeUIState on startup
'   Call ClearUICache when project changes
'
' Change Log:
'   v1.0 - Nov 2025
...
Private Const CurrentMod As String = "AB_UIState"
...
Public UIErrorShown As Boolean
...
'=======================================================
' Sub: InitializeUIState
' Purpose: Initialize UI state management system
'
' Description:
'   Initializes all UI state variables and clears caches.
...
Public Sub InitializeUIState()
    ...
    WriteLog 1, CurrentMod, "InitializeUIState", "UI state initialized"
    Exit Sub
    
ErrorHandler:
    WriteLog 3, CurrentMod, "InitializeUIState", _
...
'=======================================================
' Sub: ResetUIState
' Purpose: Reset all UI state (call on project close/change)
'
' Description:
'   Resets all UI state variables to initial values.
...
Public Sub ResetUIState()
    ...
    WriteLog 1, CurrentMod, "ResetUIState", "UI state reset"
    Exit Sub
    
ErrorHandler:
    WriteLog 3, CurrentMod, "ResetUIState", _
             "Error " & Err.Number & ": " & Err.Description
End Sub
